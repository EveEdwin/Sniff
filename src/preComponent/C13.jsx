        ...
        <div className='flex flex-col items-center  m-auto mt-10 px-4'>
            <div>
                <div className=" md:text-left w-full md:w-[881px]">
                    <span className="text-[#3F3D56] text-4xl md:text-6x tracking-wider">Why </span>
                    <span className="text-[#FE5F62] text-4xl md:text-6x tracking-wider">Sniffi</span>
                    <span className="text-[#3F3D56] text-4xl md:text-6x tracking-wider"> for </span>
                ...
                <div className="flex flex-col md:flex-row gap-6 mt-6 items-center">
                    <div className="text-justify justify-start w-full md:w-[862px]">
                        <span className="text-black text-base md:text-xl font-normal leading-loose tracking-tight">With Sniffi, </span>
