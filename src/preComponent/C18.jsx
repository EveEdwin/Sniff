        ...
        <div className='flex items-center gap-10 justify-evenly relative h-[80vh]'>
            ...
            <div className='relative '>
                ...
                <div className="text-justify justify-start mb-12 ">
                    <span className="text-[#3F3D56] text-6xl font-semibold tracking-wider">Compassionate </span>
                    <span className="text-[#FE5F62] text-6xl font-semibold tracking-wider">Care <br /></span>
                    <span className="text-[#3F3D56] text-6xl font-semibold tracking-wider">for </span>
                    <span className="text-[#FE5F62] text-6xl font-semibold tracking-wider">Every Paw!</span>
                </div>
                <div className="w-[53dvw] mb-2 text-justify justify-start text-black text-xl font-normal leading-loose tracking-tight">
                ...
                <div className="px-3.5 py-2.5 rounded-[5px] outline-1 outline-offset-[-1px] outline-[#FE5F62] inline-flex justify-center items-center gap-2">
                    <div className="text-justify justify-start text-[#FE5F62] text-sm font-normal tracking-tight">Learn More</div>
                </div>
            </div>
            <div className='relative'>
