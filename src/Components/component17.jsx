    ...
    return (
        <div className="w-full min-h-[300px] md:h-auto relative bg-[#FEC8C8]/50 mt-10 overflow-hidden px-4 md:px-8 lg:px-[102px] py-8">
            <div className="text-center md:text-justify mb-8">
                <span className="text-[#3F3D56] text-2xl md:text-4xl font-semibold font-['Inter'] tracking-wide">Diagnostic Categories by </span>
                <span className="text-[#FE5F62] text-2xl md:text-4xl font-semibold font-['Inter'] tracking-wide">Symptoms</span>
            </div>
                ...
                {[
                    ...
                    <div key={index} className="w-36 sm:w-44 md:w-52 px-3 md:px-3.5 py-3 md:py-4 bg-[#FFFFFF] rounded-xl outline-[0.59px] outline-offset-[-0.59px] outline-[#FE5F62] inline-flex flex-col justify-start items-start gap-2 overflow-hidden hover:shadow-md transition-shadow">
                        <div className="self-stretch inline-flex justify-start items-center gap-3">
                            ...
                            <div className="text-justify justify-start text-[#3F3D56] text-sm md:text-lg font-medium font-['Inter'] tracking-tight">{category}</div>
                        </div>
                    </div>
                ))}
            </div>
            ...
            <div className="flex justify-center  text-center md:text-justify text-[#FE5F62] text-xl  font-['Inter'] underline tracking-tight">
