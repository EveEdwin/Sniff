...
const SocialPage = () => {
  ...
  if (storiesLoading || eventsLoading || postsLoading) return <p>Loading...</p>;
  if (storiesError) return <p>{storiesError}</p>;
      ...
      <div className="bg-red-100/50 py-16 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-[#3F3D56] text-base md:text-xl max-w-3xl mx-auto mb-10">
            Connect with fellow pet parents, share your stories, discover
            events, and learn from each other's experiences in our vibrant
            community dedicated to the love of pets.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-4 mt-8">
        <div className="border-b border-gray-200">
          <nav className="flex justify-center md:justify-start space-x-8 overflow-x-auto">
            <button
              className={`py-4 px-2 text-md font-medium border-b-2 ${
                activeTab === "community"
                  ? "border-[#FE5F62] text-[#FE5F62]"
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 mt-2">
              Join our community events and connect with other pet lovers
            </p>
          </div>
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center text-gray-600 mb-2">
                    <FaCalendarAlt className="mr-2 text-[#FE5F62]" />{" "}
                    {event.date}
                  </div>
                  <div className="flex items-center text-gray-600 mb-3">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5 mr-2 text-[#FE5F62]"
                      viewBox="0 0 20 20"
                      fill="currentColor"
                    >
                      <path
          ...
          <div className="mt-12 bg-red-100/50 rounded-lg p-6 text-center">
            <h3 className="text-2xl font-semibold text-[#3F3D56] mb-4">
              Host Your Own Pet Event
            </h3>
            <p className="text-gray-600 mb-6">
              Have an idea for a pet-friendly event? We'd love to help you
              organize it!
            </p>
            <button className="px-6 py-3 bg-[#FE5F62] text-white rounded-md hover:bg-[#e45457] transition-colors">
      ...
      {activeTab === "stories" && (
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 mt-2">
              Inspiring tales of recovery, adoption, and extraordinary pet
              journeys
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {stories.map((story) => (
              <div
                key={story.id}
                className="bg-white rounded-xl overflow-hidden shadow-md transition-transform hover:scale-105 cursor-pointer"
              >
                ...
                <div className="p-5">
                  <div className="flex justify-between items-center mb-3">
                    <span className="bg-red-100 text-[#FE5F62] px-3 py-1 rounded-full text-xs">
                      Success Story
                    </span>
                  ...
                  <h3 className="text-[#3F3D56] font-semibold text-lg mb-2">
                    {story.title}
                  </h3>
                  ...
                  <div className="flex items-center mt-4">
                    <span className="text-[#FE5F62] text-sm hover:underline">
                      Read Full Story
                    </span>
                    <svg
                      className="w-4 h-4 ml-1 text-[#FE5F62]"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="text-center mt-12">
            <h3 className="text-xl font-medium text-[#3F3D56] mb-4">
              Have a Success Story to Share?
            </h3>
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              We'd love to hear about your pet's journey! Share your experience
              with our community and inspire other pet parents.
            </p>
            <button className="px-6 py-3 bg-[#FE5F62] text-white rounded-md hover:bg-[#e45457] transition-colors">
              Submit Your Story
            </button>
      ...
      <div className="bg-red-100/50 py-16 px-4 mt-12">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-[#3F3D56] text-base md:text-lg max-w-3xl mx-auto mb-8">
            Connect with fellow pet lovers, share your experiences, and stay
            updated on pet care tips, events, and more.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <input
              type="email"
      ...
      <div className="py-12 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex justify-center space-x-6">
            <a
              href="#"
              className="w-12 h-12 rounded-full bg-red-100 flex items-center justify-center hover:bg-[#FE5F62] hover:text-white transition-colors"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
